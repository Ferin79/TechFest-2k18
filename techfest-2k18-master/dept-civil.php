              ...
              <div class="col-sm-12">                                
                <div class="row">
                  <div class="col-sm-4 col-sm-offset-4">
                    <img src="images/dept/civil.png" class="img-responsive" alt="">    
      ...
      <div class="container">
        <div class="row">
          ...
          <!--     <i class="fa fa-5x fa-sun-o"></i>-->
                <img src="images/events/ci-venture-imbyism.png" alt="">
              </div>
              <h2>Venture Imbyism</h2>
              <p>Earn to Create!</p>
              <a href="/events/ci-venture-imbyism.php" class="btn btn-primary">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
           <!--     <i class="fa fa-5x fa-sun-o"></i>-->
                <img src="images/events/ci-aerotrembler.png" alt="">
              </div>
              <h2>Aerotrembler</h2>
              <p>You better wake when there is a shake!</p>
              <a href="/events/ci-aerotrembler.php" class="btn btn-success">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
            <!--    <i class="fa fa-5x fa-sun-o"></i>-->
                <img src="images/events/ci-span-lineup.png" alt="">
              </div>
              <h2>Span Lineup</h2>
              <p>The Bridge of Champions!</p>
              <a href="/events/ci-span-lineup.php" class="btn btn-info">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 col-sm-offset-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
               <!-- <i class="fa fa-5x fa-sun-o"></i>-->
                <img src="images/events/ci-apocalypse.png" alt="">
              </div>
              <h2>Apocalypse</h2>
              <p>Fortune Favours the Brave!</p>
              <a href="/events/ci-apocalypse.php" class="btn btn-warning">DETAIL</a>
            </div>
          </div>
        </div>
      </div>
