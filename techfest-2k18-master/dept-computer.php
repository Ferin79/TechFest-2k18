...
<html lang="en"> 
  <head>
    ...
    <title>Departments | GTU Techfest 2018</title>
              ...
              <div class="col-sm-12">                                
                <div class="row">
                  <div class="col-sm-4 col-sm-offset-4">
                    <img src="images/dept/computer.png" class="img-responsive" alt="">    
...
<!--           <p>Designed to suit you.</p> -->
    ...
    <section id="company-information" class="choose">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
          ...
          <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                ...
                <img src="images/events/co-c-atechism.png" alt="">
              </div>
              <h2>‘C’atechism</h2>  
              <p>Gear up coding knowledge by playing Quiz. <br/> &nbsp;</p>
              <a href="/events/co-c-atechism.php" class="btn btn-primary">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                <!-- <i class="fa fa-5x fa-sun-o"></i> -->
                <img src="images/events/co-e-treasure-hunt.png" alt="">
              </div>
              <h2>E-treasure Hunt</h2>
              <p>If you gaze deep enough, you can reach the treasure.</p>
              <a href="/events/co-e-treasure-hunt.php" class="btn btn-success">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                <!-- <i class="fa fa-5x fa-sun-o"></i> -->
                <img src="images/events/co-web-design.png" alt="">
              </div>
              <h2>Web Designing</h2>
              <p>Be Creative. <br/> &nbsp;</p>
              <a href="events/co-web-designing.php" class="btn btn-info">DETAIL</a>
            </div>
          </div>
          <div class="col-sm-4 col-sm-offset-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="single-service">
              <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                <!-- <i class="fa fa-5x fa-sun-o"></i> -->
                <img src="images/events/co-lan-gaming.png" alt="">
              </div>
              <h2> LAN Gaming</h2>
              <p>There is no party like a LAN party.<br/> &nbsp;</p>
              <a href="events/co-lan-gaming.php" class="btn btn-warning">DETAIL</a>
            </div>
          </div>
        </div>
      </div>
